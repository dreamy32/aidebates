  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        {/* Navbar */}
        <nav className="fixed top-0 left-0 right-0 bg-[#F7FAFC] border-b border-[#AAD8FF] z-50">
          <div className="max-w-content mx-auto px-6 h-18">
            <div className="flex items-center justify-between h-full">
              ...
              <div className="flex items-center space-x-4">
                ...
                {/* Theme Toggle */}
                <button 
                  className="p-2 rounded-full hover:bg-[#2792FD]/10 transition-colors"
                  aria-label="Toggle theme"
                >
                  <Sun className="w-5 h-5 text-[#1D3557] hover:text-[#2792FD]" />
                </button>
              </div>
            </div>
          </div>
